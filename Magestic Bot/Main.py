...
st.sidebar.title("Majestic Bot Instructions")
st.sidebar.markdown("1. You can give voice commands to the bot.")
st.sidebar.markdown("   Open browser, Spotify, Instagram")
st.sidebar.markdown("   Open Youtube, Search somthing over it")
st.sidebar.markdown("   Play Music")
st.sidebar.markdown("   Time")
st.sidebar.markdown("2. To search for images, say 'show me images of [your query].'")
st.sidebar.markdown("3. Topic name to get information")
st.sidebar.markdown("4. Check Weather")
st.sidebar.markdown("5. Top 5 news of india")
st.sidebar.markdown("6. To open translator say (Magestic Translator)")
# Add more instructions and explanations as needed

# Main content in the main section
st.title('Majestic Bot')
mixer.init()
...
var2 = ['I was created by Ridhimaa Thakur right in his computer.', 'Ridhimaa Thakur']
...
def open_new_script():
    try:
        ...
        subprocess.Popen(['streamlit', 'run', 'n.py'])
...
while True:
    ...
    if recognized_text in greetings:
        ...
        say_response('I am a Majestic bot')
